...
For users with a phone number set in `/admin`, pending goals are also surfaced via hourly escalating text messages until they check in or reply — see the "Escalating text nudges" section in `CLAUDE.md`.
